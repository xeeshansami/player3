...
public class MediaPlayerServiceVideo extends Service implements MediaPlayer.OnCompletionListener,
    ...
    int backprogress = 0;
    int backprogress1 = 0;
    public static final String ACTION_PLAY = "com.view.azhar.videoplayer.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.view.azhar.videoplayer.ACTION_PAUSE";
    public static final String ACTION_PREVIOUS = "com.view.azhar.videoplayer.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "com.view.azhar.videoplayer.ACTION_NEXT";
    public static final String ACTION_STOP = "com.view.azhar.videoplayer.ACTION_STOP";
    public static final String CLOSE_ACTION = "com.view.azhar.videoplayer.ACTION_CLOSE";
...
//        mediaPlayer.start();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
//        mSharedPrefs = getApplicationContext().getSharedPreferences("com.azhar.azhar.videoplayer", Context.MODE_PRIVATE);
