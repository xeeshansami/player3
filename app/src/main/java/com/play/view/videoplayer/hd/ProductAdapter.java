...
//            holder.duration.setTextColor(Color.parseColor("#fb0303"));
//            holder.title.setTypeface(null, Typeface.BOLD);
//            holder.headphoneimage.setImageResource(com.azhar.azhar.videoplayer.R.drawable.download);
//
//        } else {
//            holder.title.setTypeface(null, Typeface.NORMAL);
//            holder.headphoneimage.setImageResource(com.azhar.azhar.videoplayer.R.drawable.head);
//            holder.title.setTextColor(Color.parseColor("#000000"));
//            holder.duration.setTextColor(Color.parseColor("#000000"));
//
//        }
