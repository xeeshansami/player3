...
public class CustomFragment2 extends Fragment {
    ...
    public static CustomFragment2 newInstance(int audioSessionId) {
        ...
        try {
            ...
            backBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    videoFolder.equiliazerScreen = getActivity().findViewById(R.id.root_view);
                    videoFolder.equiliazerScreen.setVisibility(View.GONE);
...
//            correctPosition = false;
    ...
    public static class Builder {
        ...
        public CustomFragment2 build() {
            return CustomFragment2.newInstance(id);
        }
    }
