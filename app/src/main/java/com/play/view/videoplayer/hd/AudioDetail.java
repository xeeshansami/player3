...
//
//            Picasso.with(this).load(albumArtUri.toString()).error(com.azhar.azhar.videoplayer.R.drawable.head)
//                    .placeholder(com.azhar.azhar.videoplayer.R.drawable.head).into(thumb);
//            Picasso.with(this).load(albumArtUri.toString()).error(com.azhar.azhar.videoplayer.R.drawable.head).
//                    placeholder(com.azhar.azhar.videoplayer.R.drawable.head).into(card_image);
//
//            thumbName.setText(title);
//            thumbArtist.setText(artist);
//
    ...
    private AudioManager.OnAudioFocusChangeListener mOnAudioFocusChangeListener = new AudioManager.OnAudioFocusChangeListener() {
        ...
        public void onAudioFocusChange(int focusChange) {
            if (focusChange == AudioManager.AUDIOFOCUS_LOSS_TRANSIENT ||
                ...
                // Pause playback and reset videoplayer to the start of the file. That way, we can
