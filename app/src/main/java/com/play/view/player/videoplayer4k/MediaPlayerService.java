...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    int folderposition;
    public static final String ACTION_PLAY = "com.azhar.azhar.player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.azhar.azhar.player.ACTION_PAUSE";
    public static final String ACTION_PREVIOUS = "com.azhar.azhar.player.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "com.azhar.azhar.player.ACTION_NEXT";
    public static final String ACTION_STOP = "com.azhar.azhar.player.ACTION_STOP";
    public static final String CLOSE_ACTION = "com.azhar.azhar.player.ACTION_CLOSE";
